...
const HeaderTwo = () => {
    ...
    const address = "Stock Exchange Building, Stock Exchange Road. Karachi - 74000 Pakistan.";
                    ...
                    <div className="menu-area">
                        <div className="menu">
                            <ul className={`lab-ul ${menuToggle ? "active" : ""}`}>
                                ...
                                <li><NavLink to="/contact">Investor Education</NavLink></li>
                                <li><NavLink to="/contact">Webinars</NavLink></li>
                                <li><NavLink to="/contact">Tools</NavLink></li>
                            </ul>
                        </div>
